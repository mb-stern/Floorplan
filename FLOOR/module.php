    ...
    <div class="main">
        ...
        <aside class="sidebar">
            ...
            <div class="help">
                ...
                Gerät/Möbel/Text/Formen: Werkzeug wählen und Position anklicken.<br>Geräte: IP-Symcon-Icon wird automatisch von der zugeordneten Variable übernommen und kann manuell geändert werden.<br>Objekte: 28 Easy-Floorplan-Symbole + 9 eigene Symbole verfügbar.<br>
